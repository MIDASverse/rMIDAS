...
3. [`vignette("use_server", "rMIDAS")`](https://github.com/MIDASverse/rMIDAS/blob/master/vignettes/use_server.md) provides guidance for running **rMIDAS** in headless mode
