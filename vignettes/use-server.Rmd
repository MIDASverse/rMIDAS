...
Users may also wish to use GPU-acceleration. More information on GPU-compatible classes can be found [https://docs.aws.amazon.com/dlami/latest/devguide/gpu.html](here). Note, MIDASpy is not configured to take advantage of distributed training at present.
